    ...
    connect: function (dispatcherMode) {
      ...
      this.connection.on("disconnect", function (reason) {
        ...
        if (reason === "io server disconnect") {
          // Le serveur a initié la déconnexion, il faut se reconnecter manuellement
          self.connection.connect();
        }
        // Sinon, la reconnexion automatique s'effectuera selon les paramètres définis
      });
      ...
      this.connection.on("reconnect_failed", function () {
        ...
        // Ici, vous pouvez notifier l'utilisateur ou prendre d'autres mesures
      });
      ...
      if (dispatcherMode) {
        ...
        this.connection.on("disconnect", function () {
          ...
          setTimeout(function () {
            ...
            self.connect(); // appelle à nouveau la méthode connect
          }, 3000);
        });
      }
    },
